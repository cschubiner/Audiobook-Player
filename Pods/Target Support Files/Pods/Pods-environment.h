...
// CPSlider
#define COCOAPODS_POD_AVAILABLE_CPSlider
#define COCOAPODS_VERSION_MAJOR_CPSlider 1
#define COCOAPODS_VERSION_MINOR_CPSlider 0
#define COCOAPODS_VERSION_PATCH_CPSlider 0
